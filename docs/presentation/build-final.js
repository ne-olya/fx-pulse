...
/* ---------- 2. Сравнение коридоров ---------- */
{
  ...
  txt(s,"Узбекистан: лучший uplift, вдвое клиенту, вшестеро рынок",0.85,5.18,11.6,1,26,INK,true);
  txt(s,"Клиенту — за год при 9 переводах. Рынок — коридор целиком в год",0.85,5.66,11.6,1,26,"3A3A3A");
