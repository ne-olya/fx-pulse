...
/* ---------- 2. Сравнение коридоров ---------- */
{
  ...
  const head=["Коридор","Uplift","Сигналов","Клиенту","Рынок"];
  ...
  txt(s,"Узбекистан: вдвое больше клиенту, вшестеро больше рынок",0.85,5.18,11.6,1,26,INK,true);
  txt(s,"Рынок — весь коридор в год при росте переводов 5 % и марже 2 %",0.85,5.66,11.6,1,26,"3A3A3A");
  txt(s,"Армения и Казахстан — другой отправитель, не трудовая миграция",0.85,6.12,11.6,1,26,"3A3A3A");
}
